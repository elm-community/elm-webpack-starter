...
/***/ function(module, exports) {
	...
	Elm.Main.make = function (_elm) {
	   ...
	   var _op = {};
	   var styles = {wrapper: _U.list([{ctor: "_Tuple2",_0: "padding-top",_1: "10px"}
	   ...
	   var update = F2(function (action,model) {
	      ...
	      if (_p0.ctor === "NoOp") {
	            ...
	            return {ctor: "_Tuple2",_0: model + 1,_1: $Effects.none};
	         }
	   });
	   ...
	   var view = F2(function (address,model) {
	      return A2($Html.div,
	      _U.list([$Html$Attributes.$class("mt-palette-accent"),$Html$Attributes.style(styles.wrapper)]),
	      _U.list([$Components$Hello.hello(model)
	              ,A2($Html.p,_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "#FFF"}]))]),_U.list([$Html.text("Elm Webpack Starter")]))
	              ,A2($Html.button,_U.list([$Html$Attributes.$class("mt-button-sm"),A2($Html$Events.onClick,address,Increment)]),_U.list([$Html.text("FTW!")]))
	              ,A2($Html.img,
	              _U.list([$Html$Attributes.src("img/elm.jpg")
	                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "block"},{ctor: "_Tuple2",_0: "margin",_1: "10px auto"}]))]),
	              _U.list([]))]));
	   });
	   var init = {ctor: "_Tuple2",_0: 0,_1: $Effects.none};
	   var swap = Elm.Native.Port.make(_elm).inboundSignal("swap",
	   "Bool",
	   function (v) {
	      return typeof v === "boolean" ? v : _U.badPort("a boolean (true or false)",v);
	   });
	   var app = $StartApp.start({init: init,update: update,view: view,inputs: _U.list([A2($Signal.map,$Basics.always(NoOp),swap)])});
	   var main = app.html;
	   return _elm.Main.values = {_op: _op,app: app,main: main,init: init,view: view,NoOp: NoOp,Increment: Increment,update: update,styles: styles};
	};
